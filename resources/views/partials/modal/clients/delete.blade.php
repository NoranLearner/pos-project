...
<div class="modal fade" id="deleteModal-{{ $client->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 ">@lang('site.delete_warning') <strong>{{ $client->name }}</strong></h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('dashboard.products.forceDelete', $client->id) }}" method="POST" style="display:inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
